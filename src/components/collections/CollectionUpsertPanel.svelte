<script>
    ...
    collectionTypes[TYPE_BASE] = $json("common.database.baseTable");
    collectionTypes[TYPE_VIEW] = $json("common.database.viewTable");
    collectionTypes[TYPE_AUTH] = $json("common.database.authTable");
...
>
    <svelte:fragment slot="header">
        <h4 class="upsert-panel-title">
            {!collection.id ? $json("common.action.createTable") : $json("common.action.editTable")}
        </h4>
            ...
            <Field class="form-field collection-field-name required m-b-0" name="name" let:uniqueId>
                ...
                <div class="form-field-addon">
                    ...
                    >
                        ...
                        <span class="txt"
                            >{$_("common.placeholder.preset")}: {collectionTypes[collection.type] ||
                                "N/A"}</span
                        >
                        {#if !collection.id}
                                ...
                                {#each Object.entries(collectionTypes) as [type, label]}
                                    ...
                                    >
                                        <i
                                            ...
                                            aria-hidden="true"
                                        />
                                        <!-- <span class="txt">{label} {$_("common.placeholder.style")}</span> -->
                                    </button>
                                {/each}
                            </Toggler>
                        {/if}
        ...
        <div class="tabs-header stretched">
            ...
            {#if isAuth}
                ...
                >
                    <span class="txt">{$_("common.placeholder.option")}</span>
    ...
    <svelte:fragment slot="footer">
        ...
        <div class="btns-group no-gap">
            ...
            >
                <span class="txt"
                    >{!collection.id ? $json("common.action.create") : $json("common.action.save")}</span
                >
            </button>
